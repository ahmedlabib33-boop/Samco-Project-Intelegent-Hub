param(
    ...
    [string]$MessagePrefix = "Auto sync Project Intelligence Hub",
    [string]$Owner = "ahmedlabib33-boop",
    [string]$Repo = "Samco-Project-Intelegent-Hub",
    [string]$Branch = "main"
)
...
Write-SyncLog "Credential rule: set GITHUB_TOKEN or GH_TOKEN with repo write access before the first sync."
