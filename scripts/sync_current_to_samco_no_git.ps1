param(
    ...
    [string]$Branch = "main",
    [string]$Message = "No-Git sync Project Intelligence Hub",
    [switch]$DryRun,
    [int]$ChunkSize = 500
)
...
function Get-GitHubToken {
    ...
    throw "No GitHub token found. Set GITHUB_TOKEN or GH_TOKEN with repo write access before using no-Git sync."
}
