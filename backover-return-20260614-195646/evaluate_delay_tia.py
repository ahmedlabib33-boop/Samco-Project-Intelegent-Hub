...
TEMPLATE_DIR = ROOT / "steel_delay_tia_templates"
APP_IMPORT_DIR = ROOT / "data" / "import_templates"
...
def build_analysis() -> tuple[dict[str, pd.DataFrame | dict[str, Any]], dict[str, pd.DataFrame]]:
    ...
    rfi_df = load_first_existing_csv(
        [
            TEMPLATE_DIR / "RFI Delay.csv",
            ROOT / "Delay tia improvement files" / "upload_ready_for_delay_tia" / "RFI Delay.csv",
        ]
    )
